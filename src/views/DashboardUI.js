    ...
    <div class='layout'>
      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          ...
          <div class='status-bills-container hidden' id='status-bills-container1' data-testid = 'bill-cards-container'>
          </div>
            ...
            <div class='status-bills-container hidden' id='status-bills-container2'>
            </div>
            ...
            <div class='status-bills-container hidden' id='status-bills-container3'>
            </div>
